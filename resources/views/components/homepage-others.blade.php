...
<div class="container">
    <div class="mb-5">
    <div class="text-center fw-bold h3 series_color mt-5"><a href="{{route('actionfigure')}}">玩具公仔</a></div>
    <div class="row">
      <div class="col-6"><img class="img-fluid" src="{{$imgpaths[0]['square_0']->main_product}}" alt=""></div>
