      ...
      <div class="col-xs-8 col-lg-6 pb-4">
        <div class="row justify-content-center">
          ...
          <div class="my_message col-2">
            <a href="" class="row justify-content-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-chat-text"
                viewBox="0 0 16 16">
                <path
              ...
              <div class="text-center">
                <h6 class="pt-2 text-dark">我的訊息</h6>
              </div>
            </a>
          </div>
          <!-- 收藏清單 -->
          <div class="favorite_list col-2">
            <a href="" class="row justify-content-center">
              ...
              <div class="text-center">
                <h6 class="pt-2 text-dark">收藏清單</h6>
              </div>
            </a>
          </div>
        </div>
