    ...
    <div class="d-flex position-relative">
      ...
      <div class="position-absolute end-0">
        <a class="button_favorite" pid="{{$content[0]->pid}}">
          <svg class="favorite_empty {{$flag ? 'd-none' : ''}}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32">
          ...
          <svg class="{{$flag ? '' :'favorite_filled'}} ignite" height="32" width="32" viewBox="0 0 24 24"
